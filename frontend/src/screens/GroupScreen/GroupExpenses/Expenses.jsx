...
const Expenses = () => {
  ...
  const getGroup = async (groupId) => {
    try {
      const response = await fetch(
        `http://localhost:5000/api/v1/group/groupDetail/${groupId}/${currentPage}`,
        {
          method: "GET",
          headers: {
  ...
  async function handleSplitResolveReq(payUID, recUID) {
    ...
    try {
      const response = await fetch(
        "http://localhost:5000/api/v1/expense/reqSettel",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  async function handleSplitResolve(body) {
    try {
      const response = await fetch(
        "http://localhost:5000/api/v1/expense/settel",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  async function handleDeleteExpense(id) {
    try {
      const response = await fetch(
        `http://localhost:5000/api/v1/expense/delExpense/${id}`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
